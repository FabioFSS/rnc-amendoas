...
if not os.path.isdir('net_results/first-pass/results/'):
    os.makedirs('net_results/first-pass/results/')
...
result_dir = f'net_results/first-pass/results/{str(str_time)}/'
os.mkdir(result_dir)
...
train_dir = 'multiple_outputs_datasets/dataset1/train/' # Pasta do dataset de treino
test_dir = 'multiple_outputs_datasets/dataset1/test/' # Pasta do dataset de teste
