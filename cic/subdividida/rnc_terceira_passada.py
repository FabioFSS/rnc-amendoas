...
if not os.path.isdir('net_results/third-pass/results/'):
    os.makedirs('net_results/third-pass/results/')
...
result_dir = f'net_results/third-pass/results/{str(str_time)}/'
...
n_classes = 4 # Número de classes
class_mode = 'categorical'
train_dir = 'multiple_outputs_datasets/dataset3/train/' # Pasta do dataset de treino
test_dir = 'multiple_outputs_datasets/dataset3/test/' # Pasta do dataset de teste
...
rede.add(Dense(units=64, activation=activ_func)) # Adiciona uma camada de classificação
